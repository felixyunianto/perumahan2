<title>PT. OMAH AGENG SENTOSA</title>
<meta charset="utf-8">
...
<link rel="stylesheet" href="{{ asset('public/assets/libs/datatables/datatables.css')}}">
<script src="https://code.jquery.com/jquery-3.0.0.js"></script>
<script src="{{asset('public/assets/libs/datatables/datatables.js')}}"></script>
